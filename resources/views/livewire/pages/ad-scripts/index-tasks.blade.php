    ...
    <div class="flex flex-col gap-4">
        @forelse ($tasks as $task)
            <div
                ...
                class="rounded-xl border border-zinc-200 bg-zinc-50 p-6 shadow-xs dark:border-zinc-700 dark:bg-zinc-900 cursor-pointer hover:shadow-lg transition-shadow"
            >
